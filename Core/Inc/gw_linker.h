...
extern void * _OVERLAY_EARTHBOUND_LOAD_START[];
extern uint8_t _OVERLAY_EARTHBOUND_SIZE;
extern void * _OVERLAY_EARTHBOUND_BSS_START[];
extern void * _OVERLAY_EARTHBOUND_BSS_END[];
