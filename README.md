...
The file zelda3_assets.dat will be created in external/zelda3/tables. Copy the zelda3_assets.dat file into the `/homebrews/` folder of your sd card.
...
To play Super Mario world you need to copy the smw_assets.dat file into the `/homebrews/` folder of your sd card.
